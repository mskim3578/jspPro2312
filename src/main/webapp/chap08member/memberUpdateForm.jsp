				...
				<form class="validation-form" novalidate      action="memberUpdatePro.jsp"   method="post">
					   ...
					   <div class="col-md-3 mb-3">
						...
						<div class="col-md-6 mb-3">
							<label for="id">아이디</label> <input type="text"      class="form-control"
								id="id" placeholder="아이디" value="<%=mem.getId() %>"
								readonly  name="id">
					
						</div>
						<div class="col-md-6 mb-3">
							<label for="name">이름</label> <input type="text"    class="form-control"
								 id="name" placeholder="" value="<%=mem.getName() %>"   name="name"
								required>
						...
						<div class="col-md-6 mb-3">
							<label for="gender">남자</label> <input type="radio"
								    value="1"     <%=mem.getGender()==1 ? "checked": " " %>     name="gender">
						
						</div>
						<div class="col-md-6 mb-3">
							<label for="gender">여자</label> <input type="radio"
								  value="2"      <%=mem.getGender()==2 ? "checked": " " %>  name="gender">
					...
					<div class="mb-3">
						<label for="email">이메일</label> <input type="email"  name="email"   value="<%=mem.getEmail()%>"
							  id="email" placeholder="you@example.com"      class="form-control"
							required>
					
					</div>
					<div class="mb-3">
						<label for="tel">전화번호</label> <input type="text"
							class="form-control" id="tel" placeholder="전화번호"    name="tel"   value="<%=mem.getTel() %>"
							required>
