		...
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				onsubmit="return passChk(this)"    method="post">
					...
					<div class="mb-4"></div>
					<button class="btn btn-primary btn-lg btn-block" type="submit">비밀번호변경</button>
				</form>
			</div>
		</div>
